...
docs/reference-example-sg.md ("Alert email formats and parser traps"), reconstructed as
...
Citi Cash Back has no fixture yet — no real alert sample has been captured.
Add one, with invented merchants and amounts, once one is available.
